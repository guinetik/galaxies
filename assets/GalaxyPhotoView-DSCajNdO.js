import{I as z,d as _t,u as Mt,G as _e,A as Ct,J as Rt,c as M,a,k as le,t as _,e as S,l as X,K as $e,L as St,n as Me,f as Y,v as kt,m as We,b as ue,w as ce,T as he,F as Ce,r as Re,h as j,g as w,M as Bt,N as qe,C as Dt,O as de,E as ze,j as Pt,o as C}from"./vue-vendor-CyMGTBsb.js";import{u as Tt}from"./useGalaxyData-Wz1CFk4k.js";import{u as zt}from"./useSimbadLookup-CszcgVGG.js";import{B as Ge,c as G,C as At,V as Ft,W as Vt,O as Ut,P as It,S as Gt,D as Nt,g as Ot,h as Ht,L as Qt,i as Yt,j as je,k as Ze,l as Lt,M as Xt,a as Ae,A as Fe,b as Ve,m as Et,n as Ue}from"./three-BUZvkdOE.js";import{d as $t,b as Wt,g as qt}from"./nsaMorphologyPointCloud-Ct5fnwAD.js";import{G as ae,_ as jt}from"./index-D5ORmE3w.js";import{f as Zt,a as Jt}from"./coordinates-DJOk_Dvx.js";import"./sqljs-M9QnmiAb.js";function Je(c,e){const n=e>>>1;let o=0;for(let s=0;s<256;s++)if(o+=c[s],o>n)return s/255;return 1}function nt(c,e){return c<=0?0:c>=1?1:c===e?.5:(e-1)*c/((2*e-1)*c-e)}function Kt(c,e){const s=Je(c,e),f=new Uint32Array(256);for(let r=0;r<256;r++){if(c[r]===0)continue;const h=Math.round(Math.abs(r/255-s)*255);f[Math.min(h,255)]+=c[r]}const m=Je(f,e),p=Math.max(0,Math.min(1,s+-2.8*1.4826*m)),x=s-p,d=x>0?nt(x,.1):.5;return{c0:p,m:d}}function en(c){const{data:e,width:n,height:o}=c,s=n*o;for(let f=0;f<3;f++){const m=new Uint32Array(256);for(let r=0;r<s;r++)m[e[r*4+f]]++;const{c0:p,m:x}=Kt(m,s),d=new Uint8Array(256);for(let r=0;r<256;r++){let h=r/255;h=Math.max(0,(h-p)/(1-p)),h=nt(h,x),d[r]=Math.round(h*255)}for(let r=0;r<s;r++){const h=r*4+f;e[h]=d[e[h]]}}}const Ke=`varying vec2 vUV;
...
`;function ve(c){return c==="nsa3d"||c==="nsamorphology"?"orbit":"image-plane"}function cn(c,e,n){return{yaw:c.yaw-e*.008,pitch:c.pitch+n*.006}}function hn(c,e,n){return{sampleStep:Math.max(1,Math.ceil(Math.max(c,e)/500)),intensityThreshold:.003,depthScale:.35,sizeRange:[1.5,8.5],seed:n}}function dn(c,e){const n=[],o=Math.max(1,Math.floor(e.sampleStep)),[s,f]=e.sizeRange,m=Math.max(1,c.width-1),p=Math.max(1,c.height-1);for(let x=0;x<c.height;x+=o)for(let d=0;d<c.width;d+=o){const r=x*c.width+d,h=Math.sqrt(Q(c.bands.u[r]??0)),g=Math.sqrt(Q(c.bands.g[r]??0)),y=Math.sqrt(Q(c.bands.r[r]??0)),R=Math.sqrt(Q(c.bands.i[r]??0)),b=Math.sqrt(Q(c.bands.z[r]??0)),k=Math.sqrt(Q(c.bands.nuv[r]??0)),A=(R+b)*.5,v=(g+y)*.5,D=(h+k)*.5,P=A*.25+v*.4+D*.35;if(P<e.intensityThreshold)continue;const B=D-A,F=(et(d,x,e.seed)-.5)*2,E=(et(d+137,x+251,e.seed)-.5)*2,Z=(F*.7+E*.3+B*.25)*e.depthScale,V=c.width===1?0:d/m-.5,J=c.height===1?0:.5-x/p,N=mn(s,f,Q(P)),$=vn(h,g,y,R,b,k);n.push({x:V,y:J,z:Z,color:$,size:N,intensity:P})}return{points:n}}function vn(c,e,n,o,s,f){const m=c+e+n+o+s+f+.001,p=f/m,x=c/m,d=e/m,r=n/m,h=o/m,g=s/m,y=Q(p*.45+x*.15+d*.1+r*1+h*.9+g*.7),R=Q(p*.15+x*.2+d*.95+r*.4+h*.12+g*.05),b=Q(p*1+x*.95+d*.5+r*.08+h*.1+g*.15);return[y,R,b]}function et(c,e,n){const o=Math.sin(c*127.1+e*311.7+n*74.7)*43758.5453123;return o-Math.floor(o)}function Q(c){return Math.max(0,Math.min(1,c))}function mn(c,e,n){return c+(e-c)*n}const pn=c=>Math.pow(c,.5);function fn(c,e,n,o){const{layerCount:s,zDepthScale:f,opacityCurve:m=pn}=o,p=[],x=255/s/2;let d=!1;for(let r=0;r<c.length;r+=4)if(c[r]>0){d=!0;break}for(let r=0;r<s;r++){const h=r/(s-1),g=Math.round(h*255),y=[];for(let R=0;R<n;R++)for(let b=0;b<e;b++){const k=(R*e+b)*4,A=c[k];if(Math.abs(A-g)<=x){const v=b/e*2-1,D=R/n*2-1,P=-(h*f);y.push(v,D,P)}}if(y.length>0||!d){const R=new Ge;R.setAttribute("position",new G(new Float32Array(y),3));const b=m(h);p.push({brightness:h,opacity:b,geometry:R,zDepth:-h*f})}}return p}function tt(c){if(c.length===0)return .001;const e=c.reduce((n,o)=>{const s=Array.isArray(o)?o[0]:o.x,f=Array.isArray(o)?o[1]:o.y;return n+Math.max(f-s,0)},0);return Math.max(e/c.length*.02,.001)}function Se(c,e){return e==="nsa3d"?{Q:5,alpha:.5,sensitivity:1}:e==="nsamorphology"?{Q:5,alpha:.503,sensitivity:1}:e==="composite"?{Q:1,alpha:1,sensitivity:1}:{Q:e==="custom"?20:10,alpha:.5,sensitivity:1}}const Ie={lupton:{vert:Ke,frag:tn},composite:{vert:Ke,frag:nn},custom:{vert:an,frag:on},volumetric:{vert:sn,frag:rn},nsamorphology:{vert:at,frag:ot}};class gn{constructor(e){this.planeMaterial=null,this.pointMaterial=null,this.morphMaterial=null,this.mesh=null,this.pointCloud=null,this.morphCloud=null,this.densityMeshes=[],this.densityMaterials=[],this.textures=[],this.animationId=null,this.bandData={},this.currentTheme="astral",this.currentShader="lupton",this.width=1,this.height=1,this.clock=new At,this.autoParams={Q:10,alpha:.5,sensitivity:1},this.targetZoom=1,this.targetX=0,this.targetY=0,this.velX=0,this.velY=0,this.lerpSpeed=.15,this.friction=.92,this.velThreshold=1e-4,this.orbitYaw=0,this.orbitPitch=0,this.orbitRadius=2.5,this.targetOrbitYaw=0,this.targetOrbitPitch=0,this.targetOrbitRadius=2.5,this.minOrbitRadius=1.1,this.maxOrbitRadius=5,this.orbitLerpSpeed=.12,this.orbitTarget=z(new Ft(0,0,0)),this.renderer=z(new Vt({canvas:e,antialias:!1,alpha:!1})),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.orthographicCamera=z(new Ut(-1,1,1,-1,0,100)),this.orthographicCamera.position.z=10,this.perspectiveCamera=z(new It(48,1,.01,100)),this.perspectiveCamera.position.set(0,0,2.5),this.activeCamera=this.orthographicCamera,this.scene=z(new Gt)}async load(e,n){var h,g;const o=`${ae}/${e}/`,s=["i","r","g"];n.bands.includes("u")&&s.push("u"),n.bands.includes("z")&&s.push("z"),n.bands.includes("nuv")&&s.push("nuv");const f=await Promise.all(s.map(async y=>{const b=await(await fetch(`${o}${y}.png`)).arrayBuffer(),k=$t(new Uint8Array(b)),A=k.depth===16?65535:255,v=new Float32Array(k.width*k.height),D=k.data,P=k.channels;for(let F=0;F<v.length;F++)v[F]=D[F*P]/A;const B=z(new Nt(v,k.width,k.height,Ot,Ht));return B.generateMipmaps=!0,B.minFilter=Qt,B.magFilter=Yt,B.wrapS=je,B.wrapT=je,B.needsUpdate=!0,{tex:B,floats:v,width:k.width,height:k.height}}));s.forEach((y,R)=>{const{tex:b,floats:k,width:A,height:v}=f[R];this.textures.push(b),this.bandData[y]={tex:b,range:new Ze(n.data_ranges[y][0],n.data_ranges[y][1]),raw:k,width:A,height:v}});const m=this.bandData.g?this.bandData.g.range.y-this.bandData.g.range.x:1;for(const y of["u","z","nuv"]){const R=this.bandData[y];if(!R)continue;const b=R.range.y-R.range.x;b<m*.01&&(console.warn(`[NSA] Discarding ${y}-band: dynamic range ${b.toFixed(4)} too narrow (g-band: ${m.toFixed(4)})`),delete this.bandData[y])}const p=((h=this.renderer.domElement.parentElement)==null?void 0:h.clientWidth)||window.innerWidth,x=((g=this.renderer.domElement.parentElement)==null?void 0:g.clientHeight)||window.innerHeight*.6,d=this.bandData;this.planeMaterial=z(this.createPlaneMaterial(d,p,x)),this.pointMaterial=z(this.createPointMaterial()),this.morphMaterial=z(this.createMorphMaterial());const r=z(new Lt(2,2));this.mesh=z(new Xt(r,this.planeMaterial)),this.scene.add(this.mesh),this.pointCloud=z(this.createPointCloudObject(e)),this.pointCloud.visible=!1,this.scene.add(this.pointCloud),this.morphCloud=z(this.createMorphCloudObject(e)),this.morphCloud.visible=!1,this.scene.add(this.morphCloud),this.resize(p,x),this.applyCurrentShaderMode(),this.setTheme(this.currentTheme),this.autoParams=Se(n,this.currentShader),this.startAnimation()}createPlaneMaterial(e,n,o){var f,m,p,x,d,r,h,g;const s=[e.i.range,e.r.range,e.g.range];return new Ae({uniforms:{uBandR:{value:e.i.tex},uBandG:{value:e.r.tex},uBandB:{value:e.g.tex},uAlpha:{value:.014},uBrightness:{value:.5},uQ:{value:20},uStretch:{value:tt(s)},uSensitivity:{value:.88},uRangeR:{value:e.i.range},uRangeG:{value:e.r.range},uRangeB:{value:e.g.range},uGrayscale:{value:0},uTheme:{value:1},uBand_u:{value:((f=e.u)==null?void 0:f.tex)??e.g.tex},uBand_g:{value:e.g.tex},uBand_r:{value:e.r.tex},uBand_i:{value:e.i.tex},uBand_z:{value:((m=e.z)==null?void 0:m.tex)??e.i.tex},uBand_nuv:{value:((p=e.nuv)==null?void 0:p.tex)??((x=e.u)==null?void 0:x.tex)??e.g.tex},uRange_u:{value:((d=e.u)==null?void 0:d.range)??e.g.range},uRange_g:{value:e.g.range},uRange_r:{value:e.r.range},uRange_i:{value:e.i.range},uRange_z:{value:((r=e.z)==null?void 0:r.range)??e.i.range},uRange_nuv:{value:((h=e.nuv)==null?void 0:h.range)??((g=e.u)==null?void 0:g.range)??e.g.range},uHas_u:{value:e.u?1:0},uHas_g:{value:e.g?1:0},uHas_r:{value:e.r?1:0},uHas_i:{value:e.i?1:0},uHas_z:{value:e.z?1:0},uHas_nuv:{value:e.nuv?1:0},uTime:{value:0},uResolution:{value:new Ze(n*this.renderer.getPixelRatio(),o*this.renderer.getPixelRatio())}},vertexShader:Ie.lupton.vert,fragmentShader:Ie.lupton.frag})}createPointMaterial(){return new Ae({uniforms:{uAlpha:{value:1},uQ:{value:20},uSensitivity:{value:1},uTheme:{value:1},uGrayscale:{value:0},uTime:{value:0},uPixelRatio:{value:this.renderer.getPixelRatio()}},vertexShader:ln,fragmentShader:un,transparent:!0,depthWrite:!1,blending:Fe})}createMorphMaterial(){return new Ae({uniforms:{uAlpha:{value:1},uQ:{value:20},uSensitivity:{value:1},uTheme:{value:1},uGrayscale:{value:0},uTime:{value:0},uPixelRatio:{value:this.renderer.getPixelRatio()}},vertexShader:at,fragmentShader:ot,transparent:!0,depthWrite:!1,blending:Fe})}createPointCloudObject(e){const n=this.extractPointCloudBands(),o=dn(n,hn(n.width,n.height,e)),s=o.points.length,f=new Float32Array(s*3),m=new Float32Array(s*3),p=new Float32Array(s),x=new Float32Array(s);let d=1;for(let h=0;h<s;h+=1){const g=o.points[h];f[h*3]=g.x,f[h*3+1]=g.y,f[h*3+2]=g.z,m[h*3]=g.color[0],m[h*3+1]=g.color[1],m[h*3+2]=g.color[2],p[h]=g.size,x[h]=g.intensity,d=Math.max(d,Math.sqrt(g.x*g.x+g.y*g.y+g.z*g.z))}const r=z(new Ge);return r.setAttribute("position",new G(f,3)),r.setAttribute("aPosition",new G(f,3)),r.setAttribute("color",new G(m,3)),r.setAttribute("aSize",new G(p,1)),r.setAttribute("aIntensity",new G(x,1)),r.computeBoundingSphere(),this.minOrbitRadius=Math.max(.15,d*.2),this.maxOrbitRadius=Math.max(4.5,d*5),this.orbitRadius=Math.max(this.minOrbitRadius*1.4,d*1.3),this.targetOrbitRadius=this.orbitRadius,this.perspectiveCamera.near=.01,this.perspectiveCamera.far=this.maxOrbitRadius*4,this.perspectiveCamera.updateProjectionMatrix(),new Ve(r,this.pointMaterial??void 0)}createMorphCloudObject(e){const n=this.extractPointCloudBands(),o=Wt(n,qt(n.width,n.height,e)),s=o.points.length,f=new Float32Array(s*3),m=new Float32Array(s*3),p=new Float32Array(s),x=new Float32Array(s),d=new Float32Array(s);for(let h=0;h<s;h+=1){const g=o.points[h];f[h*3]=g.x,f[h*3+1]=g.y,f[h*3+2]=g.z,m[h*3]=g.color[0],m[h*3+1]=g.color[1],m[h*3+2]=g.color[2],p[h]=g.size,x[h]=g.intensity,d[h]=g.filamentarity}const r=z(new Ge);return r.setAttribute("position",new G(f,3)),r.setAttribute("aPosition",new G(f,3)),r.setAttribute("color",new G(m,3)),r.setAttribute("aSize",new G(p,1)),r.setAttribute("aIntensity",new G(x,1)),r.setAttribute("aFilamentarity",new G(d,1)),r.computeBoundingSphere(),new Ve(r,this.morphMaterial??void 0)}extractPointCloudBands(){const e=s=>this.bandData[s]?s:s==="u"?"g":s==="z"?"i":this.bandData.u?"u":"g",{width:n,height:o}=this.bandData.i;return{width:n,height:o,bands:{u:this.extractSingleBand(e("u")),g:this.extractSingleBand(e("g")),r:this.extractSingleBand(e("r")),i:this.extractSingleBand(e("i")),z:this.extractSingleBand(e("z")),nuv:this.extractSingleBand(e("nuv"))}}}extractSingleBand(e){const n=this.bandData[e],o=n.raw,s=n.range,f=s.x,m=s.y-s.x,p=new Float32Array(o.length);for(let d=0;d<o.length;d++){const r=o[d]*m+f;p[d]=Math.max(r,0)}let x=0;for(let d=0;d<p.length;d++)p[d]>x&&(x=p[d]);if(x>0)for(let d=0;d<p.length;d++)p[d]/=x;return p}extractImageData(e){const n=this.bandData[e],o=n.raw,s=n.width,f=n.height,m=new Uint8ClampedArray(o.length*4);for(let p=0;p<o.length;p++){const x=Math.round(o[p]*255);m[p*4]=x,m[p*4+1]=x,m[p*4+2]=x,m[p*4+3]=255}return{data:m,width:s,height:f}}createDensityMeshes(){this.disposeDensityMeshes();const{data:e,width:n,height:o}=this.extractImageData("i");fn(e,n,o,{layerCount:15,zDepthScale:1}).forEach(m=>{const p=z(new Et({color:16777215,size:.015,opacity:m.opacity,transparent:!0,depthWrite:!1,blending:Fe,sizeAttenuation:!0})),x=z(new Ve(m.geometry,p));x.position.z=m.zDepth,this.scene.add(x),this.densityMeshes.push(x),this.densityMaterials.push(p)})}disposeDensityMeshes(){for(const e of this.densityMeshes)this.scene.remove(e),e.geometry&&e.geometry.dispose();for(const e of this.densityMaterials)e.dispose();this.densityMeshes=[],this.densityMaterials=[]}applyCurrentShaderMode(){const n=ve(this.currentShader)==="orbit";if(this.activeCamera=n?this.perspectiveCamera:this.orthographicCamera,this.mesh&&(this.mesh.visible=!n),this.pointCloud&&(this.pointCloud.visible=this.currentShader==="nsa3d"),this.morphCloud&&(this.morphCloud.visible=this.currentShader==="nsamorphology"),!n&&this.planeMaterial){const o=Ie[this.currentShader];this.planeMaterial.vertexShader=o.vert,this.planeMaterial.fragmentShader=o.frag,this.planeMaterial.needsUpdate=!0}}startAnimation(){const e=()=>{const n=this.clock.getElapsedTime();if(this.planeMaterial&&(this.planeMaterial.uniforms.uTime.value=n),this.pointMaterial&&(this.pointMaterial.uniforms.uTime.value=n),this.morphMaterial&&(this.morphMaterial.uniforms.uTime.value=n),ve(this.currentShader)==="image-plane"){Math.abs(this.velX)>this.velThreshold||Math.abs(this.velY)>this.velThreshold?(this.targetX+=this.velX,this.targetY+=this.velY,this.velX*=this.friction,this.velY*=this.friction):(this.velX=0,this.velY=0);const o=Math.max(0,1-1/this.targetZoom);this.targetX=Math.max(-o,Math.min(o,this.targetX)),this.targetY=Math.max(-o,Math.min(o,this.targetY));const s=this.lerpSpeed;this.orthographicCamera.zoom+=(this.targetZoom-this.orthographicCamera.zoom)*s,this.orthographicCamera.position.x+=(this.targetX-this.orthographicCamera.position.x)*s,this.orthographicCamera.position.y+=(this.targetY-this.orthographicCamera.position.y)*s,this.orthographicCamera.updateProjectionMatrix()}else this.updateOrbitCamera();this.render(),this.animationId=requestAnimationFrame(e)};this.animationId=requestAnimationFrame(e)}updateOrbitCamera(){this.targetOrbitPitch=Ue.clamp(this.targetOrbitPitch,-1.25,1.25),this.targetOrbitRadius=Ue.clamp(this.targetOrbitRadius,this.minOrbitRadius,this.maxOrbitRadius);const e=this.orbitLerpSpeed;this.orbitYaw+=(this.targetOrbitYaw-this.orbitYaw)*e,this.orbitPitch+=(this.targetOrbitPitch-this.orbitPitch)*e,this.orbitRadius+=(this.targetOrbitRadius-this.orbitRadius)*e;const n=Math.cos(this.orbitPitch);this.perspectiveCamera.position.set(Math.sin(this.orbitYaw)*n*this.orbitRadius,Math.sin(this.orbitPitch)*this.orbitRadius,Math.cos(this.orbitYaw)*n*this.orbitRadius),this.perspectiveCamera.lookAt(this.orbitTarget),this.perspectiveCamera.updateProjectionMatrix()}stopAnimation(){this.animationId!==null&&(cancelAnimationFrame(this.animationId),this.animationId=null)}setParams(e,n,o){ve(this.currentShader)==="image-plane"?this.planeMaterial&&(this.planeMaterial.uniforms.uQ.value=e,this.planeMaterial.uniforms.uAlpha.value=n,this.planeMaterial.uniforms.uBrightness.value=n,this.planeMaterial.uniforms.uSensitivity.value=o):this.currentShader==="nsa3d"?this.pointMaterial&&(this.pointMaterial.uniforms.uQ.value=e,this.pointMaterial.uniforms.uAlpha.value=n,this.pointMaterial.uniforms.uSensitivity.value=o):this.currentShader==="nsamorphology"&&this.morphMaterial&&(this.morphMaterial.uniforms.uQ.value=e,this.morphMaterial.uniforms.uAlpha.value=n,this.morphMaterial.uniforms.uSensitivity.value=o),this.render()}setBands(e,n,o){const s=this.bandData;!this.planeMaterial||!s[e]||!s[n]||!s[o]||(this.planeMaterial.uniforms.uBandR.value=s[e].tex,this.planeMaterial.uniforms.uBandG.value=s[n].tex,this.planeMaterial.uniforms.uBandB.value=s[o].tex,this.planeMaterial.uniforms.uRangeR.value=s[e].range,this.planeMaterial.uniforms.uRangeG.value=s[n].range,this.planeMaterial.uniforms.uRangeB.value=s[o].range,this.planeMaterial.uniforms.uStretch.value=tt([s[e].range,s[n].range,s[o].range]))}setTheme(e){if(!this.planeMaterial&&!this.pointMaterial||this.currentTheme===e)return;const n=[this.planeMaterial,this.pointMaterial,this.morphMaterial].filter(Boolean);for(const o of n)o.uniforms.uGrayscale.value=0;if(e==="grayscale"){this.setBands("i","r","g");for(const o of n)o.uniforms.uGrayscale.value=1,o.uniforms.uTheme.value=0}else if(e==="infra"){this.setBands("i","r","g");for(const o of n)o.uniforms.uTheme.value=0}else if(e==="astral"){this.setBands("i","r","g");for(const o of n)o.uniforms.uTheme.value=1}this.currentTheme=e,this.render()}getAutoParams(){return this.autoParams}setShader(e){!this.planeMaterial&&!this.pointMaterial||this.currentShader===e||(this.currentShader=e,this.applyCurrentShaderMode(),this.render())}is3DMode(){return ve(this.currentShader)==="orbit"}supportsSkyPicking(){return ve(this.currentShader)==="image-plane"}render(){!this.planeMaterial&&!this.pointMaterial&&!this.morphMaterial||this.renderer.render(this.scene,this.activeCamera)}resize(e,n){if(this.width=e,this.height=n,this.renderer.setSize(e,n,!1),this.planeMaterial){const o=this.renderer.getPixelRatio();this.planeMaterial.uniforms.uResolution.value.set(e*o,n*o)}this.pointMaterial&&(this.pointMaterial.uniforms.uPixelRatio.value=this.renderer.getPixelRatio()),this.morphMaterial&&(this.morphMaterial.uniforms.uPixelRatio.value=this.renderer.getPixelRatio()),this.perspectiveCamera.aspect=e/Math.max(n,1),this.perspectiveCamera.updateProjectionMatrix(),this.render()}pan(e,n){if(this.is3DMode())return;const o=this.targetZoom,s=e/this.width*2/o,f=n/this.height*2/o;this.targetX-=s,this.targetY+=f,this.velX=0,this.velY=0}fling(e,n){if(this.is3DMode())return;const o=this.targetZoom;this.velX=-(e/this.width)*2/o,this.velY=n/this.height*2/o}zoomAt(e,n,o){if(this.is3DMode())return;const s=this.targetZoom,f=Math.max(1,Math.min(s*e,50)),m=n/this.width*2-1,p=-(o/this.height)*2+1,x=this.targetX+m/s,d=this.targetY+p/s;this.targetZoom=f,this.targetX=x-m/f,this.targetY=d-p/f,this.velX=0,this.velY=0}orbit(e,n){if(!this.is3DMode())return;const o=cn({yaw:this.targetOrbitYaw,pitch:this.targetOrbitPitch},e,n);this.targetOrbitYaw=o.yaw,this.targetOrbitPitch=o.pitch}dolly(e){if(!this.is3DMode())return;const n=this.targetOrbitRadius/Math.max(e,.01);this.targetOrbitRadius=Ue.clamp(n,this.minOrbitRadius,this.maxOrbitRadius)}screenToRaDec(e,n,o){if(!this.supportsSkyPicking())return null;const s=this.orthographicCamera.zoom,f=e/this.width*2-1,m=-(n/this.height)*2+1,p=this.orthographicCamera.position.x+f/s,x=this.orthographicCamera.position.y+m/s,d=(p+1)/2,r=(x+1)/2;if(d<0||d>1||r<0||r>1)return null;const[h,g]=o.dimensions,y=d*h,R=(1-r)*g,b=y-h/2,k=R-g/2,A=(o.pixel_scale??.396)/3600,v=o.dec*Math.PI/180,D=o.dec-k*A;return{ra:o.ra-b*A/Math.cos(v),dec:D}}resetView(){if(this.is3DMode()){this.targetOrbitYaw=0,this.targetOrbitPitch=0,this.targetOrbitRadius=Math.max(this.minOrbitRadius*1.4,1.5);return}this.targetZoom=1,this.targetX=0,this.targetY=0,this.velX=0,this.velY=0}dispose(){var e,n,o;this.stopAnimation(),this.textures.forEach(s=>s.dispose()),this.textures=[],this.planeMaterial&&this.planeMaterial.dispose(),this.pointMaterial&&this.pointMaterial.dispose(),this.morphMaterial&&this.morphMaterial.dispose(),(e=this.mesh)!=null&&e.geometry&&this.mesh.geometry.dispose(),(n=this.pointCloud)!=null&&n.geometry&&this.pointCloud.geometry.dispose(),(o=this.morphCloud)!=null&&o.geometry&&this.morphCloud.geometry.dispose(),this.disposeDensityMeshes(),this.renderer.dispose()}}async function xn(c){const e=new Image;e.crossOrigin="anonymous",e.src=c,await new Promise((f,m)=>{e.onload=()=>f(),e.onerror=()=>m(new Error("Failed to load image"))});const n=document.createElement("canvas");n.width=e.naturalWidth,n.height=e.naturalHeight;const o=n.getContext("2d");o.drawImage(e,0,0);const s=o.getImageData(0,0,n.width,n.height);return en(s),s}const yn=[{label:"Normal",value:"none"},{label:"Negative",value:"invert(1)"},{label:"Cyanotype",value:"sepia(1) hue-rotate(180deg) saturate(1.5)"},{label:"Amber",value:"sepia(1) saturate(1.5)"},{label:"Hard",value:"contrast(1.5) brightness(0.9)"}],bn={class:"photo-scroll",ref:"scrollContainer"},wn={class:"photo-page"},_n={class:"photo-hero"},Mn={class:"hero-content"},Cn={class:"hero-links"},Rn=["disabled"],Sn={class:"photo-hero-title"},kn={class:"photo-hero-subtitle"},Bn={key:0,class:"status-container"},Dn={key:1,class:"status-container error"},Pn={key:2,class:"content-grid"},Tn={class:"glass-card canvas-card"},zn={class:"card-header"},An={class:"header-actions"},Fn={class:"canvas-wrapper"},Vn={class:"canvas-loading-overlay"},Un={key:0,class:"crosshair-overlay",style:{cursor:"crosshair"}},In=["x1","x2","y2"],Gn=["y1","x2","y2"],Nn=["cx","cy"],On={key:1,class:"coord-hud"},Hn={class:"params-overlay"},Qn=["aria-expanded","aria-label"],Yn={key:0,class:"tune-drawer"},Ln={class:"tune-drawer-content"},Xn={class:"tune-drawer-header"},En={class:"tune-drawer-title"},$n={class:"tune-drawer-body"},Wn={class:"control-group"},qn={class:"theme-toggle"},jn=["onClick"],Zn={key:0,class:"control-group"},Jn={class:"label-row"},Kn={class:"param-value"},ea={class:"control-group"},ta={class:"label-row"},na={class:"param-value"},aa={class:"control-group"},oa={class:"label-row"},ia={class:"param-value"},sa={class:"glass-card bands-card"},ra={class:"card-header"},la={class:"card-title"},ua={class:"bands-grid"},ca=["onClick"],ha={class:"band-img-wrap"},da=["src","alt"],va={class:"band-badge"},ma={class:"lightbox-content"},pa={class:"lightbox-header"},fa={class:"lightbox-title"},ga={class:"lightbox-body"},xa={class:"lightbox-image-wrap"},ya=["src","alt"],ba={class:"lightbox-controls"},wa={class:"lb-control-group"},_a={class:"lb-control-group"},Ma=["value"],Ca={class:"lb-control-group"},Ra={class:"lb-control-group"},Sa=["aria-label"],ka={class:"sidebar-content"},Ba=["aria-label"],Da={class:"sidebar-title"},Pa={class:"sidebar-section"},Ta={class:"sidebar-section"},za={class:"tooltip-content"},Aa={key:0,class:"loading-state"},Fa={key:1,class:"error-state"},Va={key:2,class:"empty-state"},Ua={key:3,class:"results-list"},Ia=["href"],Ga={class:"obj-name"},Na={class:"obj-type"},Oa=_t({__name:"GalaxyPhotoView",setup(c){const{t:e}=Mt(),n=Pt(),o=Dt(),{ready:s,getGalaxyByPgc:f,getRandomGalaxies:m}=Tt(),{loading:p,results:x,query:d,error:r}=zt(),h=j(()=>{const i=x.value.filter(t=>t.type==="Star"||t.type==="Galaxy");return i.length>0?i:x.value.slice(0,5)}),g=j(()=>Number(n.params.pgc)),y=w(null),R=w(null),b=w(null),k=w(!0),A=w(!1),v=Bt(null),D=w(10),P=w(.0515),B=w(1),F=w(null),E=w(null),Ne=j(()=>{var i;return((i=b.value)==null?void 0:i.bands)||["u","g","r","i","z"]}),Z=w("astral"),V=w("lupton"),J=j(()=>V.value==="nsa3d"||V.value==="nsamorphology"),N=w(!1),$=w(!1),K=w(!1),L=w(!1),U=w({visible:!1,x:0,y:0,objects:[]}),ee=w(!1),me=w(0),pe=w(0),I=new Map;let oe=-1,O=[];const te=w(null),ne=w(null);let ie=-1,fe=-1;const ge=w(0),xe=w(0),ke=w(0),Be=w(0),ye=w(100),be=w(100),se=w("none"),W=w(!1),Oe=w(null),De=new Map,He=j(()=>{const i=`brightness(${ye.value}%) contrast(${be.value}%)`,t=se.value!=="none"?se.value:"";return{filter:`${i} ${t}`}}),it=j(()=>{const u=U.value.x,l=U.value.y-120-16;return{left:u+"px",top:Math.max(60,l)+"px"}}),st=j(()=>!J.value&&te.value!==null&&ne.value!==null);function Qe(){if(!v.value||!b.value)return;const{Q:i,alpha:t,sensitivity:u}=Se(b.value,V.value);D.value=i,P.value=t,B.value=u,re(),V.value==="lupton"&&(H.Q=i,H.alpha=t,H.sensitivity=u)}function Ye(){o.push(`/g/${g.value}`)}async function rt(i){try{return(await fetch(`${ae}/${i}/metadata.json`)).ok}catch{return!1}}async function lt(){if(K.value)return;K.value=!0;const i=100;for(let t=0;t<i;t++){const l=m(20).filter(T=>T.pgc!==g.value);for(const T of l)if(await rt(T.pgc)){o.push(`/g/${T.pgc}/photo`),K.value=!1;return}}K.value=!1}function re(){v.value&&v.value.setParams(D.value,P.value,B.value)}_e(Z,i=>{v.value&&v.value.setTheme(i)});const H={Q:10,alpha:.1555,sensitivity:.88};_e(V,(i,t)=>{if(v.value){if(t==="lupton"&&(H.Q=D.value,H.alpha=P.value,H.sensitivity=B.value),i==="lupton"&&b.value){const u=H,l=Se(b.value,"lupton");D.value=u.Q!==l.Q?u.Q:l.Q,P.value=u.alpha!==l.alpha?u.alpha:l.alpha,B.value=u.sensitivity}else if(b.value){const u=Se(b.value,i);D.value=u.Q,P.value=u.alpha,B.value=u.sensitivity}(i==="nsa3d"||i==="nsamorphology")&&(L.value=!1,U.value.visible=!1,te.value=null,ne.value=null),v.value.setShader(i),re()}});function ut(i){const t=Oe.value;if(!t)return;t.width=i.width,t.height=i.height,t.getContext("2d").putImageData(i,0,0)}async function ct(){if(W.value=!W.value,W.value&&F.value){await qe();const i=F.value;let t=De.get(i);if(!t){const u=`${ae}/${g.value}/${i}.png`;t=await xn(u),De.set(i,t)}ut(t)}}function ht(i){F.value=i,ye.value=100,be.value=100,se.value="none",W.value=!1}function Le(){F.value=null}function dt(){J.value||(L.value=!L.value,U.value.visible=!1)}function vt(i){if(i.preventDefault(),!v.value||!y.value)return;const t=i.deltaY>0?.9:1.1,u=y.value.getBoundingClientRect(),l=i.clientX-u.left,T=i.clientY-u.top;v.value.is3DMode()?v.value.dolly(t):(v.value.zoomAt(t,l,T),we())}function Xe(){const[i,t]=Array.from(I.values()),u=i.clientX-t.clientX,l=i.clientY-t.clientY;return Math.sqrt(u*u+l*l)}function mt(){const[i,t]=Array.from(I.values());return{x:(i.clientX+t.clientX)/2,y:(i.clientY+t.clientY)/2}}function pt(i){!v.value||!y.value||(y.value.setPointerCapture(i.pointerId),I.set(i.pointerId,i),I.size===1?(ee.value=!0,me.value=i.clientX,pe.value=i.clientY,O=[{x:i.clientX,y:i.clientY,t:performance.now()}]):I.size===2&&(ee.value=!1,oe=Xe()))}function ft(i){if(!(!v.value||!y.value)&&I.has(i.pointerId)){if(I.set(i.pointerId,i),I.size===1&&ee.value){const t=i.clientX-me.value,u=i.clientY-pe.value;v.value.is3DMode()?v.value.orbit(t,u):v.value.pan(t,u),me.value=i.clientX,pe.value=i.clientY;const l=performance.now();for(O.push({x:i.clientX,y:i.clientY,t:l});O.length>1&&l-O[0].t>80;)O.shift();v.value.is3DMode()||we()}else if(I.size===2){const t=Xe();if(oe>0){const u=t/oe,l=mt(),T=y.value.getBoundingClientRect();v.value.is3DMode()?v.value.dolly(u):v.value.zoomAt(u,l.x-T.left,l.y-T.top)}oe=t,v.value.is3DMode()||we()}}}function Pe(i){if(!y.value)return;const t=ee.value&&I.size===1;if(y.value.releasePointerCapture(i.pointerId),I.delete(i.pointerId),I.size<2&&(oe=-1),I.size===1){const u=I.values().next().value;u&&(me.value=u.clientX,pe.value=u.clientY),ee.value=!0}else{if(ee.value=!1,t&&v.value&&!v.value.is3DMode()&&O.length>=2){const u=O[0],l=O[O.length-1],T=(l.t-u.t)/1e3;if(T>.005){const q=(l.x-u.x)/T*.016,wt=(l.y-u.y)/T*.016;v.value.fling(q,wt)}}O=[]}}function we(){if(!v.value||!b.value||ie<0||!v.value.supportsSkyPicking())return;const i=v.value.screenToRaDec(ie,fe,b.value);i?(te.value=i.ra,ne.value=i.dec):(te.value=null,ne.value=null)}function gt(i){if(J.value||!y.value)return;const t=y.value.getBoundingClientRect();ie=i.clientX-t.left,fe=i.clientY-t.top,L.value&&(ge.value=ie,xe.value=fe),we()}async function xt(i){if(!L.value||!y.value||!b.value||!v.value||!v.value.supportsSkyPicking())return;const t=y.value.getBoundingClientRect(),u=i.clientX-t.left,l=i.clientY-t.top,T=v.value.screenToRaDec(u,l,b.value);if(T){U.value={visible:!0,x:i.clientX,y:i.clientY,objects:[],error:void 0};try{await d(T.ra,T.dec,30),r.value?U.value.error=r.value:U.value.objects=h.value.map(q=>({name:q.name,type:q.type,simbadUrl:q.simbadUrl}))}catch(q){U.value.error="Failed to query SIMBAD",console.error("SIMBAD query error:",q)}}}function yt(){ie=-1,fe=-1,te.value=null,ne.value=null}async function bt(i){try{const t=await fetch(`${ae}/${i}/metadata.json`);t.ok?b.value=await t.json():b.value=null}catch(t){console.error("Failed to load NSA metadata:",t),b.value=null}}async function Ee(i){var t;k.value=!0,b.value=null,A.value=!1,F.value=null,De.clear(),(t=E.value)==null||t.disconnect(),E.value=null,v.value&&(v.value.dispose(),v.value=null),await s,R.value=f(i),await bt(i),k.value=!1;for(let u=0;u<3&&(await qe(),!y.value);u++);if(b.value&&y.value){await new Promise(u=>setTimeout(u,0));try{if(v.value=new gn(y.value),await v.value.load(i,b.value),A.value=!0,v.value.setParams(D.value,P.value,B.value),v.value.setTheme(Z.value),Qe(),H.Q=D.value,H.alpha=P.value,H.sensitivity=B.value,E.value=new ResizeObserver(()=>{if(v.value&&y.value){const u=y.value.parentElement.getBoundingClientRect();v.value.resize(u.width,u.height),ke.value=u.width,Be.value=u.height}}),E.value.observe(y.value.parentElement),y.value.parentElement){const u=y.value.parentElement.getBoundingClientRect();ke.value=u.width,Be.value=u.height}}catch(u){console.error("Failed to load NSA scene:",u),A.value=!0}}}Ct(()=>{Ee(g.value)}),_e(()=>n.params.pgc,(i,t)=>{if(!t)return;const u=Number(i),l=Number(t);u&&u!==l&&Ee(u)});const Te=i=>{i.key==="Escape"&&(N.value=!1)};return _e(N,i=>{i?document.addEventListener("keydown",Te):document.removeEventListener("keydown",Te)},{immediate:!0}),Rt(()=>{var i;document.removeEventListener("keydown",Te),(i=E.value)==null||i.disconnect(),v.value&&v.value.dispose()}),(i,t)=>{var u;return C(),M("div",bn,[a("div",wn,[a("section",_n,[a("div",Mn,[a("div",Cn,[a("button",{class:"back-link",onClick:Ye},[t[13]||(t[13]=a("span",null,"←",-1)),le(" "+_(S(e)("pages.galaxyPhoto.back")||"Back to Galaxy"),1)]),a("button",{class:"shuffle-link",disabled:K.value,onClick:lt},_(K.value?"…":"↻")+" "+_(S(e)("pages.galaxyPhoto.shuffleAnother")),9,Rn)]),a("h1",Sn,[t[14]||(t[14]=a("span",{class:"title-accent"},"PGC",-1)),le(" "+_(((u=R.value)==null?void 0:u.pgc)||g.value),1)]),a("p",kn,_(S(e)("pages.galaxyPhoto.title")),1)])]),k.value?(C(),M("div",Bn,[t[15]||(t[15]=a("div",{class:"loading-spinner"},null,-1)),a("p",null,_(S(e)("app.loading")),1)])):b.value?(C(),M("div",Pn,[a("div",Tn,[a("div",zn,[t[17]||(t[17]=a("h2",{class:"card-title"},"Composite Imaging",-1)),a("div",An,[X(a("select",{"onUpdate:modelValue":t[0]||(t[0]=l=>V.value=l),class:"shader-select"},[...t[16]||(t[16]=[St('<option value="lupton" data-v-f6c1cf7d>Lupton et al.</option><option value="composite" data-v-f6c1cf7d>Composite</option><option value="custom" data-v-f6c1cf7d>Custom</option><option value="volumetric" data-v-f6c1cf7d>Volumetric</option><option value="nsa3d" data-v-f6c1cf7d>NSA 3D</option><option value="nsamorphology" data-v-f6c1cf7d>Morphology 3D</option>',6)])],512),[[$e,V.value]]),J.value?Y("",!0):(C(),M("button",{key:0,class:Me(["find-objects-btn",{active:L.value}]),onClick:dt,"aria-label":"Find objects at location",title:"Click to activate, then click canvas to query SIMBAD"}," ✦ ",2)),a("button",{class:"info-btn",onClick:t[1]||(t[1]=l=>N.value=!N.value),"aria-label":"Info"}," i ")])]),a("div",Fn,[X(a("div",Vn,[t[18]||(t[18]=a("div",{class:"loading-spinner"},null,-1)),a("p",null,_(S(e)("app.loading")||"Loading..."),1)],512),[[kt,!A.value]]),a("canvas",{ref_key:"canvasEl",ref:y,class:Me(["composite-canvas",{"find-objects-mode":L.value}]),onWheel:We(vt,["prevent"]),onClick:xt,onPointerdown:pt,onPointermove:ft,onPointerup:Pe,onPointercancel:Pe,onPointerleave:Pe,onMousemove:gt,onMouseleave:yt},null,34),L.value?(C(),M("svg",Un,[a("line",{x1:ge.value,y1:"0",x2:ge.value,y2:Be.value,class:"crosshair-line"},null,8,In),a("line",{x1:"0",y1:xe.value,x2:ke.value,y2:xe.value,class:"crosshair-line"},null,8,Gn),a("circle",{cx:ge.value,cy:xe.value,r:"4",class:"crosshair-dot"},null,8,Nn)])):Y("",!0),st.value?(C(),M("div",On,[t[19]||(t[19]=a("span",{class:"coord-label"},"RA",-1)),le(" "+_(S(Zt)(te.value))+"   ",1),t[20]||(t[20]=a("span",{class:"coord-label"},"Dec",-1)),le(" "+_(S(Jt)(ne.value)),1)])):Y("",!0),a("div",Hn,[a("button",{class:"params-toggle",onClick:t[2]||(t[2]=l=>$.value=!$.value),"aria-expanded":$.value,"aria-label":S(e)("pages.galaxyPhoto.tuneImage")},_(S(e)("pages.galaxyPhoto.tuneImage")),9,Qn)]),ue(he,{name:"drawer"},{default:ce(()=>[$.value?(C(),M("div",Yn,[a("div",Ln,[a("div",Xn,[a("h2",En,_(S(e)("pages.galaxyPhoto.params.title")||"Rendering Parameters"),1),a("button",{class:"tune-drawer-close",onClick:t[3]||(t[3]=l=>$.value=!1),"aria-label":"Close"}," × ")]),a("div",$n,[a("button",{class:"best-fit-btn tune-best-fit",onClick:Qe,title:"Reset to auto-calibrated values"}," Best Fit "),a("div",Wn,[t[21]||(t[21]=a("label",null,"Spectral Theme",-1)),a("div",qn,[(C(),M(Ce,null,Re([{id:"grayscale",label:"Grayscale"},{id:"infra",label:"Infrared"},{id:"astral",label:"Astral"}],l=>a("button",{key:l.id,class:Me(["theme-btn",{active:Z.value===l.id}]),onClick:T=>Z.value=l.id},_(l.label),11,jn)),64))])]),V.value!=="composite"?(C(),M("div",Zn,[a("div",Jn,[a("label",null,_(S(e)("pages.galaxyPhoto.params.q"))+" (Stretch)",1),a("span",Kn,_(D.value.toFixed(1)),1)]),X(a("input",{"onUpdate:modelValue":t[4]||(t[4]=l=>D.value=l),type:"range",min:"1",max:"100",step:"0.5",class:"custom-range",onInput:re},null,544),[[de,D.value,void 0,{number:!0}]])])):Y("",!0),a("div",ea,[a("div",ta,[a("label",null,_(S(e)("pages.galaxyPhoto.params.alpha"))+" (Brightness)",1),a("span",na,_(P.value.toFixed(4)),1)]),X(a("input",{"onUpdate:modelValue":t[5]||(t[5]=l=>P.value=l),type:"range",min:"0.001",max:"10.0",step:"0.001",class:"custom-range",onInput:re},null,544),[[de,P.value,void 0,{number:!0}]])]),a("div",aa,[a("div",oa,[t[22]||(t[22]=a("label",null,"Sensitivity",-1)),a("span",ia,_(B.value.toFixed(2)),1)]),X(a("input",{"onUpdate:modelValue":t[6]||(t[6]=l=>B.value=l),type:"range",min:"0.01",max:"1.0",step:"0.01",class:"custom-range",onInput:re},null,544),[[de,B.value,void 0,{number:!0}]])])])])])):Y("",!0)]),_:1})])]),a("section",sa,[a("div",ra,[a("h2",la,_(S(e)("pages.galaxyPhoto.bands")),1)]),a("div",ua,[(C(!0),M(Ce,null,Re(Ne.value,l=>(C(),M("div",{key:l,class:"band-item",onClick:T=>ht(l)},[a("div",ha,[a("img",{src:`${S(ae)}/${g.value}/${l}.png`,alt:`${l}-band`,loading:"lazy",crossorigin:"anonymous"},null,8,da),t[23]||(t[23]=a("div",{class:"band-overlay"},[a("span",{class:"zoom-icon"},"⤢")],-1))]),a("span",va,_(l),1)],8,ca))),128))])])])):(C(),M("div",Dn,[a("p",null,_(S(e)("pages.galaxyPhoto.notAvailable")),1),a("button",{class:"action-btn",onClick:Ye},"Return to Map")]))]),ue(he,{name:"fade"},{default:ce(()=>[F.value?(C(),M("div",{key:0,class:"lightbox",onClick:We(Le,["self"])},[a("div",ma,[a("button",{class:"lightbox-close",onClick:Le},"×"),a("div",pa,[a("h2",fa,_(F.value)+"-band Raw Data",1),t[24]||(t[24]=a("span",{class:"lightbox-subtitle"},"Sloan Digital Sky Survey",-1))]),a("div",ga,[a("div",xa,[W.value?(C(),M("canvas",{key:0,ref_key:"stfCanvasEl",ref:Oe,class:"lightbox-image",style:ze(He.value)},null,4)):(C(),M("img",{key:1,class:"lightbox-image",src:`${S(ae)}/${g.value}/${F.value}.png`,alt:`${F.value}-band`,style:ze(He.value),crossorigin:"anonymous"},null,12,ya)),a("div",ba,[a("div",wa,[t[25]||(t[25]=a("label",null,"Auto STF",-1)),a("button",{class:Me(["stf-toggle",{active:W.value}]),onClick:ct},_(W.value?"ON":"OFF"),3)]),a("div",_a,[t[26]||(t[26]=a("label",null,"Filter",-1)),X(a("select",{"onUpdate:modelValue":t[7]||(t[7]=l=>se.value=l),class:"lb-select"},[(C(!0),M(Ce,null,Re(S(yn),l=>(C(),M("option",{key:l.label,value:l.value},_(l.label),9,Ma))),128))],512),[[$e,se.value]])]),a("div",Ca,[t[27]||(t[27]=a("label",null,"Brightness",-1)),X(a("input",{type:"range","onUpdate:modelValue":t[8]||(t[8]=l=>ye.value=l),min:"0",max:"200",class:"custom-range"},null,512),[[de,ye.value,void 0,{number:!0}]])]),a("div",Ra,[t[28]||(t[28]=a("label",null,"Contrast",-1)),X(a("input",{type:"range","onUpdate:modelValue":t[9]||(t[9]=l=>be.value=l),min:"0",max:"200",class:"custom-range"},null,512),[[de,be.value,void 0,{number:!0}]])])])])])])])):Y("",!0)]),_:1}),ue(he,{name:"fade"},{default:ce(()=>[N.value?(C(),M("div",{key:0,class:"info-sidebar-backdrop","aria-hidden":"true",onClick:t[10]||(t[10]=l=>N.value=!1)})):Y("",!0)]),_:1}),ue(he,{name:"sidebar"},{default:ce(()=>[N.value?(C(),M("div",{key:0,class:"info-sidebar",role:"dialog","aria-modal":"true","aria-label":S(e)("pages.galaxyPhoto.info.title")},[a("div",ka,[a("button",{class:"sidebar-close",type:"button","aria-label":S(e)("app.close")||"Close",onClick:t[11]||(t[11]=l=>N.value=!1)}," × ",8,Ba),a("h2",Da,_(S(e)("pages.galaxyPhoto.info.title")),1),a("div",Pa,[t[29]||(t[29]=a("h3",null,"Data Source",-1)),a("p",null,_(S(e)("pages.galaxyPhoto.info.dataSource")),1)]),a("div",Ta,[a("h3",null,_(V.value==="lupton"?"Lupton Composite":V.value==="composite"?"Raw Composite":V.value==="custom"?"Custom Composite":V.value==="volumetric"?"Volumetric Rendering":V.value==="nsa3d"?"NSA 3D Point Cloud":"Morphology 3D"),1),a("p",null,_(S(e)("pages.galaxyPhoto.info."+V.value)),1)])])],8,Sa)):Y("",!0)]),_:1}),ue(he,{name:"fade"},{default:ce(()=>[U.value.visible?(C(),M("div",{key:0,class:"simbad-tooltip",style:ze(it.value)},[t[33]||(t[33]=a("div",{class:"tooltip-arrow"},null,-1)),a("div",za,[S(p)?(C(),M("div",Aa,[...t[30]||(t[30]=[a("div",{class:"mini-spinner"},null,-1),a("span",null,"Querying SIMBAD...",-1)])])):U.value.error?(C(),M("div",Fa,[t[31]||(t[31]=a("span",{class:"error-icon"},"⚠",-1)),le(" "+_(U.value.error),1)])):U.value.objects.length===0?(C(),M("div",Va," No objects found ")):(C(),M("div",Ua,[(C(!0),M(Ce,null,Re(U.value.objects,l=>(C(),M("a",{key:l.name,href:l.simbadUrl,target:"_blank",rel:"noopener noreferrer",class:"result-item result-link"},[a("span",Ga,_(l.name),1),a("span",Na,_(l.type),1),t[32]||(t[32]=a("span",{class:"link-icon"},"↗",-1))],8,Ia))),128))])),a("button",{class:"tooltip-close",onClick:t[12]||(t[12]=l=>U.value.visible=!1)},"×")])],4)):Y("",!0)]),_:1})],512)}}}),qa=jt(Oa,[["__scopeId","data-v-f6c1cf7d"]]);export{qa as default};
