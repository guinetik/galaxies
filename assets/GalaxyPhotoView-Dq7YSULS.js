import{I as z,d as _t,u as Mt,G as _e,A as Ct,J as Rt,c as M,a,k as le,t as _,e as S,l as X,K as $e,L as St,n as Me,f as Y,v as kt,m as We,b as ue,w as ce,T as he,F as Ce,r as Re,h as j,g as w,M as Bt,N as qe,C as Dt,O as de,E as ze,j as Pt,o as C}from"./vue-vendor-CyMGTBsb.js";import{u as Tt}from"./useGalaxyData-Wz1CFk4k.js";import{u as zt}from"./useSimbadLookup-1pF_W-N7.js";import{B as Ge,c as G,C as At,V as Ft,W as Vt,O as Ut,P as It,S as Gt,D as Nt,g as Ot,h as Ht,L as Qt,i as Yt,j as je,k as Ze,l as Lt,M as Xt,a as Ae,A as Fe,b as Ve,m as Et,n as Ue}from"./three-Bsxc-RuM.js";import{d as $t,b as Wt,g as qt}from"./nsaMorphologyPointCloud-Ct5fnwAD.js";import{G as ae,_ as jt}from"./index-CFJA0m8O.js";import{f as Zt,a as Jt}from"./coordinates-DJOk_Dvx.js";import"./sqljs-M9QnmiAb.js";function Je(c,e){const n=e>>>1;let o=0;for(let s=0;s<256;s++)if(o+=c[s],o>n)return s/255;return 1}function nt(c,e){return c<=0?0:c>=1?1:c===e?.5:(e-1)*c/((2*e-1)*c-e)}function Kt(c,e){const s=Je(c,e),f=new Uint32Array(256);for(let r=0;r<256;r++){if(c[r]===0)continue;const h=Math.round(Math.abs(r/255-s)*255);f[Math.min(h,255)]+=c[r]}const m=Je(f,e),p=Math.max(0,Math.min(1,s+-2.8*1.4826*m)),x=s-p,d=x>0?nt(x,.1):.5;return{c0:p,m:d}}function en(c){const{data:e,width:n,height:o}=c,s=n*o;for(let f=0;f<3;f++){const m=new Uint32Array(256);for(let r=0;r<s;r++)m[e[r*4+f]]++;const{c0:p,m:x}=Kt(m,s),d=new Uint8Array(256);for(let r=0;r<256;r++){let h=r/255;h=Math.max(0,(h-p)/(1-p)),h=nt(h,x),d[r]=Math.round(h*255)}for(let r=0;r<s;r++){const h=r*4+f;e[h]=d[e[h]]}}}const Ke=`varying vec2 vUV;
