...
`,Mt=new q(0,1,0),Z=new J;class Me{constructor(t,n){this.animationId=0,this.clock=new Ht,this.galaxyRotation=0,this._bhScreenVec=new q,this.orbitQuat=new J,this.zoom=4,this.targetZoom=4,this.isDragging=!1,this.lastX=0,this.lastY=0,this.velocityX=0,this.velocityY=0,this.renderer=new Wt({canvas:t,antialias:!0,alpha:!0}),this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.setSize(t.clientWidth,t.clientHeight,!1),this.scene=new xt,this.renderer.setClearColor(0,1),this.params=Qt(n);const o=oe(this.params),i=this.params.galaxyRadius;this.baseDistance=i*1.7;const r=t.clientWidth/t.clientHeight;this.camera=new $t(60,r,.1,this.baseDistance*20),this.particles=new he(o,this.baseDistance),this.scene.add(this.particles.points),this.haze=new ue(i),this.scene.add(this.haze.mesh),this.nebula=new pe(o,i,n.pgc),this.scene.add(this.nebula.mesh),this.blackHole=new ye(null,i*.08),this.scene.add(this.blackHole.depthMesh),this.scene.add(this.blackHole.mesh),this.particles.points.layers.set(1),this.haze.mesh.layers.set(1),this.nebula.mesh.layers.set(1);const s=t.clientWidth,a=t.clientHeight;this.galaxyRT=new Xt(s*window.devicePixelRatio,a*window.devicePixelRatio,{minFilter:tt,magFilter:tt}),this.lensingMaterial=new at({vertexShader:xe,fragmentShader:be,uniforms:{uSceneTexture:{value:this.galaxyRT.texture},uBHScreenPos:{value:new gt(.5,.5)},uLensStrength:{value:0},uAspectRatio:{value:s/a}},depthTest:!1,depthWrite:!1});const d=new Y(new st(2,2),this.lensingMaterial);this.lensingScene=new xt,this.lensingScene.add(d),this.lensingCamera=new qt(-1,1,1,-1,0,1);const c=(n.pgc*2654435761>>>0)/4294967296*Math.PI*2,u=new J().setFromAxisAngle(new q(1,0,0),-.45),v=new J().setFromAxisAngle(Mt,c);this.orbitQuat.multiplyQuaternions(u,v),this.onPointerDown=m=>{this.isDragging=!0,this.lastX=m.clientX,this.lastY=m.clientY,this.velocityX=0,this.velocityY=0},this.onPointerMove=m=>{if(!this.isDragging)return;const y=m.clientX-this.lastX,g=m.clientY-this.lastY;this.velocityX=y*.005,this.velocityY=g*.005,this.applyOrbitDelta(this.velocityX,this.velocityY),this.lastX=m.clientX,this.lastY=m.clientY},this.onPointerUp=()=>{this.isDragging=!1},this.onWheel=m=>{m.preventDefault();const y=this.targetZoom*.12;this.targetZoom+=m.deltaY>0?-y:y,this.targetZoom=Math.max(.1,Math.min(20,this.targetZoom))},t.addEventListener("pointerdown",this.onPointerDown),t.addEventListener("pointermove",this.onPointerMove),t.addEventListener("pointerup",this.onPointerUp),t.addEventListener("wheel",this.onWheel,{passive:!1}),this.resizeObserver=new ResizeObserver(()=>{const m=t.clientWidth,y=t.clientHeight;if(m===0||y===0)return;this.renderer.setSize(m,y,!1),this.camera.aspect=m/y,this.camera.updateProjectionMatrix();const g=this.renderer.getPixelRatio();this.galaxyRT.setSize(m*g,y*g),this.lensingMaterial.uniforms.uAspectRatio.value=m/y}),this.resizeObserver.observe(t)}applyOrbitDelta(t,n){Z.setFromAxisAngle(Mt,-t),this.orbitQuat.premultiply(Z);const o=new q(1,0,0).applyQuaternion(this.orbitQuat);Z.setFromAxisAngle(o,-n),this.orbitQuat.premultiply(Z),this.orbitQuat.normalize()}start(){this.clock.start();const t=()=>{this.animationId=requestAnimationFrame(t);const n=this.clock.getDelta(),o=this.clock.getElapsedTime();this.isDragging||(Math.abs(this.velocityX)>1e-4||Math.abs(this.velocityY)>1e-4)&&(this.applyOrbitDelta(this.velocityX,this.velocityY),this.velocityX*=.92,this.velocityY*=.92),this.zoom+=(this.targetZoom-this.zoom)*.08;const i=this.baseDistance/this.zoom,r=new q(0,0,i).applyQuaternion(this.orbitQuat);this.camera.position.copy(r),this.camera.lookAt(0,0,0),this.camera.updateMatrixWorld(!0);const s=Math.min(this.zoom/20,1),a=.02+.18*s*s;this.galaxyRotation+=n*a,this.particles.update(n,o);const d=this.params.type==="elliptical"?this.params.axisRatio:1;this.nebula.update(o,this.camera,this.galaxyRotation,this.params.galaxyRadius,d);const c=this.camera.position,f=Math.sqrt(c.x*c.x+c.z*c.z),u=Math.atan2(c.y,f),v=Math.atan2(c.x,c.z);this.blackHole.update(o,u,v,this.camera,this.renderer),this._bhScreenVec.set(0,0,0).project(this.camera);const m=this._bhScreenVec.x*.5+.5,y=this._bhScreenVec.y*.5+.5,g=this.blackHole.getLOD(),x=g*g*.03;x<.001?(this.camera.layers.enableAll(),this.renderer.setRenderTarget(null),this.renderer.render(this.scene,this.camera)):(this.camera.layers.set(1),this.renderer.setRenderTarget(this.galaxyRT),this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.lensingMaterial.uniforms.uBHScreenPos.value.set(m,y),this.lensingMaterial.uniforms.uLensStrength.value=x,this.renderer.setRenderTarget(null),this.renderer.clear(),this.renderer.render(this.lensingScene,this.lensingCamera),this.camera.layers.set(2),this.renderer.autoClear=!1,this.renderer.render(this.scene,this.camera),this.renderer.autoClear=!0)};t()}dispose(){cancelAnimationFrame(this.animationId);const t=this.renderer.domElement;t.removeEventListener("pointerdown",this.onPointerDown),t.removeEventListener("pointermove",this.onPointerMove),t.removeEventListener("pointerup",this.onPointerUp),t.removeEventListener("wheel",this.onWheel),this.resizeObserver.disconnect(),this.particles.dispose(),this.haze.dispose(),this.nebula.dispose(),this.blackHole.dispose(),this.galaxyRT.dispose(),this.lensingMaterial.dispose(),this.renderer.dispose()}}const _e=et({__name:"GalaxyDetail",props:{galaxy:{}},setup(e){const t=e,n=ht(null);let o=null;return _t(()=>{n.value&&(o=new Me(n.value,t.galaxy),o.start())}),Pt(()=>{o==null||o.dispose(),o=null}),(i,r)=>(C(),P("canvas",{ref_key:"canvasRef",ref:n,class:"galaxy-detail-canvas"},null,512))}}),we=nt(_e,[["__scopeId","data-v-ca9938ca"]]),Se={class:"galaxy-info-card"},ze={class:"info-row"},Re={class:"info-label"},Ce={key:0,class:"procedural-mark",title:"Procedurally assigned"},ke={class:"info-row"},De={key:0,class:"info-row"},Pe={class:"info-row"},Ae={key:0},Te={key:1,class:"info-row info-methods"},Fe={class:"method-list"},Ie=["title"],Be=et({__name:"GalaxyInfoCard",props:{galaxy:{}},setup(e){const{t}=mt(),n=e,o=K(()=>ft(n.galaxy.pgc,n.galaxy.morphology)),i=K(()=>{const r=n.galaxy,s=[];return r.dm_snia!=null&&s.push({key:"snia",abbr:"SNIa"}),r.dm_tf!=null&&s.push({key:"tf",abbr:"TF"}),r.dm_fp!=null&&s.push({key:"fp",abbr:"FP"}),r.dm_sbf!=null&&s.push({key:"sbf",abbr:"SBF"}),r.dm_snii!=null&&s.push({key:"snii",abbr:"SNII"}),r.dm_trgb!=null&&s.push({key:"trgb",abbr:"TRGB"}),r.dm_ceph!=null&&s.push({key:"ceph",abbr:"Ceph"}),r.dm_mas!=null&&s.push({key:"mas",abbr:"Mas"}),s});return(r,s)=>(C(),P("div",Se,[l("div",ze,[l("span",Re,h(p(t)("pages.galaxy.fields.morphology.label")),1),X(" "+h(p(t)("morphology."+o.value)),1),e.galaxy.morphology?T("",!0):(C(),P("sup",Ce,"p"))]),l("div",ke,[s[0]||(s[0]=l("span",{class:"info-label"},"Distance",-1)),X(" "+h(e.galaxy.distance_mpc.toFixed(1))+" Mpc ("+h(Math.round(e.galaxy.distance_mly).toLocaleString())+" Mly) ",1)]),e.galaxy.vcmb!=null?(C(),P("div",De,[s[1]||(s[1]=l("span",{class:"info-label"},"CMB Velocity",-1)),X(" "+h(e.galaxy.vcmb.toLocaleString())+" km/s ",1)])):T("",!0),l("div",Pe,[s[2]||(s[2]=l("span",{class:"info-label"},"DM",-1)),X(" "+h(e.galaxy.dm.toFixed(2)),1),e.galaxy.e_dm!=null?(C(),P("span",Ae," ± "+h(e.galaxy.e_dm.toFixed(2)),1)):T("",!0)]),i.value.length>0?(C(),P("div",Te,[s[3]||(s[3]=l("span",{class:"info-label"},"Methods",-1)),l("span",Fe,[(C(!0),P(ut,null,wt(i.value,a=>(C(),P("span",{key:a.abbr,class:"method-tag",title:p(t)(`pages.about.data.methods.${a.key}.desc`)},h(a.abbr),9,Ie))),128))])])):T("",!0)]))}}),Oe=nt(Be,[["__scopeId","data-v-2dd99b08"]]),Ne={key:0,class:"data-sidebar"},Ge={class:"sidebar-scroll"},Ue={class:"sidebar-title"},Ve={class:"data-row"},Le={class:"data-label"},Ee={class:"data-value"},He={class:"data-desc"},We={class:"data-row"},$e={class:"data-label"},Xe={class:"data-value"},qe={class:"data-desc"},Ye={class:"data-row"},je={class:"data-label"},Ze={class:"data-value"},Qe={class:"data-desc"},Je={class:"data-row"},Ke={class:"data-label"},ta={class:"data-value"},ea={class:"data-desc"},aa={class:"sidebar-section"},sa={class:"data-row"},na={class:"data-label"},oa={class:"data-value"},ia={class:"data-desc"},ra={class:"data-row"},la={class:"data-label"},ca={class:"data-value"},da={class:"data-desc"},ha={class:"data-row"},ua={class:"data-label"},ga={class:"data-value"},ma={class:"data-desc"},pa={class:"data-row"},fa={class:"data-label"},va={class:"data-value"},ya={class:"data-desc"},xa={class:"data-row"},ba={class:"data-label"},Ma={class:"data-value"},_a={class:"data-desc"},wa={class:"sidebar-section"},Sa={class:"data-row"},za={class:"data-label"},Ra={class:"data-value"},Ca={class:"data-desc"},ka={class:"data-row"},Da={class:"data-label"},Pa={class:"data-value"},Aa={class:"data-desc"},Ta={class:"data-row"},Fa={class:"data-label"},Ia={class:"data-value"},Ba={class:"data-desc"},Oa={class:"data-row"},Na={class:"data-label"},Ga={class:"data-value"},Ua={class:"data-desc"},Va={class:"data-row"},La={class:"data-label"},Ea={class:"data-value"},Ha={class:"data-desc"},Wa={class:"data-row"},$a={class:"data-label"},Xa={class:"data-value"},qa={class:"data-desc"},Ya={class:"sidebar-section"},ja={class:"data-label"},Za={class:"data-value"},Qa={class:"data-desc"},Ja=et({__name:"GalaxyDataSidebar",props:{galaxy:{},show:{type:Boolean}},emits:["update:show"],setup(e){const{t}=mt(),n=e,o=K(()=>ft(n.galaxy.pgc,n.galaxy.morphology));function i(a,d){const c=a.toFixed(d);return a>=0?"+"+c:c}function r(a,d){if(a==null)return null;const c=a.toFixed(2);return d!=null?`${c} ± ${d.toFixed(2)}`:c}const s=K(()=>{const a=n.galaxy,d=[],c=[["dm_snia",a.dm_snia,a.e_dm_snia],["dm_tf",a.dm_tf,a.e_dm_tf],["dm_fp",a.dm_fp,a.e_dm_fp],["dm_sbf",a.dm_sbf,a.e_dm_sbf],["dm_snii",a.dm_snii,a.e_dm_snii],["dm_trgb",a.dm_trgb,a.e_dm_trgb],["dm_ceph",a.dm_ceph,a.e_dm_ceph],["dm_mas",a.dm_mas,a.e_dm_mas]];for(const[f,u,v]of c){const m=r(u,v);m&&d.push({key:f,value:m})}return d});return(a,d)=>(C(),Q(At,{name:"slide-right"},{default:St(()=>[e.show?(C(),P("div",Ne,[l("div",Ge,[l("button",{class:"sidebar-close",onClick:d[0]||(d[0]=c=>a.$emit("update:show",!1))},"×"),l("h2",Ue,h(p(t)("pages.galaxy.sections.identity")),1),l("div",Ve,[l("div",Le,h(p(t)("pages.galaxy.fields.pgc.label")),1),l("div",Ee,h(e.galaxy.pgc),1),l("div",He,h(p(t)("pages.galaxy.fields.pgc.desc")),1)]),l("div",We,[l("div",$e,h(p(t)("pages.galaxy.fields.group_pgc.label")),1),l("div",Xe,h(e.galaxy.group_pgc??"—"),1),l("div",qe,h(p(t)("pages.galaxy.fields.group_pgc.desc")),1)]),l("div",Ye,[l("div",je,h(p(t)("pages.galaxy.fields.t17.label")),1),l("div",Ze,h(e.galaxy.t17??"—"),1),l("div",Qe,h(p(t)("pages.galaxy.fields.t17.desc")),1)]),l("div",Je,[l("div",Ke,h(p(t)("pages.galaxy.fields.morphology.label")),1),l("div",ta,h(p(t)("morphology."+o.value)),1),l("div",ea,h(p(t)("pages.galaxy.fields.morphology.desc")),1)]),l("h2",aa,h(p(t)("pages.galaxy.sections.distance")),1),l("div",sa,[l("div",na,h(p(t)("pages.galaxy.fields.dm.label")),1),l("div",oa,h(e.galaxy.dm.toFixed(2))+" mag",1),l("div",ia,h(p(t)("pages.galaxy.fields.dm.desc")),1)]),l("div",ra,[l("div",la,h(p(t)("pages.galaxy.fields.e_dm.label")),1),l("div",ca,h(e.galaxy.e_dm!=null?"± "+e.galaxy.e_dm.toFixed(2)+" mag":"—"),1),l("div",da,h(p(t)("pages.galaxy.fields.e_dm.desc")),1)]),l("div",ha,[l("div",ua,h(p(t)("pages.galaxy.fields.distance_mpc.label")),1),l("div",ga,h(e.galaxy.distance_mpc.toFixed(1))+" Mpc",1),l("div",ma,h(p(t)("pages.galaxy.fields.distance_mpc.desc")),1)]),l("div",pa,[l("div",fa,h(p(t)("pages.galaxy.fields.distance_mly.label")),1),l("div",va,h(Math.round(e.galaxy.distance_mly).toLocaleString())+" Mly",1),l("div",ya,h(p(t)("pages.galaxy.fields.distance_mly.desc")),1)]),l("div",xa,[l("div",ba,h(p(t)("pages.galaxy.fields.vcmb.label")),1),l("div",Ma,h(e.galaxy.vcmb!=null?e.galaxy.vcmb.toLocaleString()+" km/s":"—"),1),l("div",_a,h(p(t)("pages.galaxy.fields.vcmb.desc")),1)]),l("h2",wa,h(p(t)("pages.galaxy.sections.coordinates")),1),l("div",Sa,[l("div",za,h(p(t)("pages.galaxy.fields.ra.label")),1),l("div",Ra,h(e.galaxy.ra.toFixed(4))+"°",1),l("div",Ca,h(p(t)("pages.galaxy.fields.ra.desc")),1)]),l("div",ka,[l("div",Da,h(p(t)("pages.galaxy.fields.dec.label")),1),l("div",Pa,h(i(e.galaxy.dec,4))+"°",1),l("div",Aa,h(p(t)("pages.galaxy.fields.dec.desc")),1)]),l("div",Ta,[l("div",Fa,h(p(t)("pages.galaxy.fields.glon.label")),1),l("div",Ia,h(e.galaxy.glon!=null?e.galaxy.glon.toFixed(4)+"°":"—"),1),l("div",Ba,h(p(t)("pages.galaxy.fields.glon.desc")),1)]),l("div",Oa,[l("div",Na,h(p(t)("pages.galaxy.fields.glat.label")),1),l("div",Ga,h(e.galaxy.glat!=null?i(e.galaxy.glat,4)+"°":"—"),1),l("div",Ua,h(p(t)("pages.galaxy.fields.glat.desc")),1)]),l("div",Va,[l("div",La,h(p(t)("pages.galaxy.fields.sgl.label")),1),l("div",Ea,h(e.galaxy.sgl!=null?e.galaxy.sgl.toFixed(3)+"°":"—"),1),l("div",Ha,h(p(t)("pages.galaxy.fields.sgl.desc")),1)]),l("div",Wa,[l("div",$a,h(p(t)("pages.galaxy.fields.sgb.label")),1),l("div",Xa,h(e.galaxy.sgb!=null?i(e.galaxy.sgb,3)+"°":"—"),1),l("div",qa,h(p(t)("pages.galaxy.fields.sgb.desc")),1)]),s.value.length>0?(C(),P(ut,{key:0},[l("h2",Ya,h(p(t)("pages.galaxy.sections.methods")),1),(C(!0),P(ut,null,wt(s.value,c=>(C(),P("div",{key:c.key,class:"data-row"},[l("div",ja,h(p(t)("pages.galaxy.fields."+c.key+".label")),1),l("div",Za,h(c.value),1),l("div",Qa,h(p(t)("pages.galaxy.fields."+c.key+".desc")),1)]))),128))],64)):T("",!0)])])):T("",!0)]),_:1}))}}),Ka=nt(Ja,[["__scopeId","data-v-47db02e9"]]),ts={class:"w-full h-full"},es={key:1,class:"galaxy-title"},as={class:"top-buttons"},ss={key:4,class:"not-found"},ns=et({__name:"GalaxyView",setup(e){const{t}=mt(),n=Ft(),{ready:o,isLoading:i,getGalaxyByPgc:r}=Yt(),s=ht(null),a=ht(!1);return _t(async()=>{await o,s.value=r(Number(n.params.pgc))}),(d,c)=>{const f=It("router-link");return C(),P("div",ts,[s.value?(C(),Q(we,{key:0,galaxy:s.value},null,8,["galaxy"])):T("",!0),s.value?(C(),P("div",es,"PGC "+h(s.value.pgc),1)):T("",!0),s.value?(C(),Q(Oe,{key:2,galaxy:s.value},null,8,["galaxy"])):T("",!0),l("div",as,[l("button",{class:"data-button",onClick:c[0]||(c[0]=u=>a.value=!a.value)},h(p(t)("pages.galaxy.dataButton")),1),Tt(f,{to:"/",class:"back-button"},{default:St(()=>[...c[2]||(c[2]=[X("← Back",-1)])]),_:1})]),s.value?(C(),Q(Ka,{key:3,galaxy:s.value,show:a.value,"onUpdate:show":c[1]||(c[1]=u=>a.value=u)},null,8,["galaxy","show"])):T("",!0),!s.value&&!p(i)?(C(),P("div",ss,"Galaxy not found")):T("",!0)])}}}),cs=nt(ns,[["__scopeId","data-v-da36072f"]]);export{cs as default};
