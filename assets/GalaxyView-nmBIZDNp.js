...
`,Mt=new q(0,1,0),Z=new J;class Me{constructor(t,n){this.animationId=0,this.clock=new Ht,this.galaxyRotation=0,this._bhScreenVec=new q,this.orbitQuat=new J,this.zoom=4,this.targetZoom=4,this.isDragging=!1,this.isPinching=!1,this.lastX=0,this.lastY=0,this.velocityX=0,this.velocityY=0,this.lastPinchDist=0,this.renderer=new Wt({canvas:t,antialias:!0,alpha:!0}),this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.setSize(t.clientWidth,t.clientHeight,!1),this.scene=new xt,this.renderer.setClearColor(0,1),this.params=Qt(n);const i=ie(this.params),o=this.params.galaxyRadius;this.baseDistance=o*1.7;const r=t.clientWidth/t.clientHeight;this.camera=new Xt(60,r,.1,this.baseDistance*20),this.particles=new he(i,this.baseDistance),this.scene.add(this.particles.points),this.haze=new ue(o),this.scene.add(this.haze.mesh),this.nebula=new pe(i,o,n.pgc),this.scene.add(this.nebula.mesh),this.blackHole=new ye(null,o*.08),this.scene.add(this.blackHole.depthMesh),this.scene.add(this.blackHole.mesh),this.particles.points.layers.set(1),this.haze.mesh.layers.set(1),this.nebula.mesh.layers.set(1);const s=t.clientWidth,a=t.clientHeight;this.galaxyRT=new $t(s*window.devicePixelRatio,a*window.devicePixelRatio,{minFilter:tt,magFilter:tt}),this.lensingMaterial=new at({vertexShader:xe,fragmentShader:be,uniforms:{uSceneTexture:{value:this.galaxyRT.texture},uBHScreenPos:{value:new gt(.5,.5)},uLensStrength:{value:0},uAspectRatio:{value:s/a}},depthTest:!1,depthWrite:!1});const h=new Y(new st(2,2),this.lensingMaterial);this.lensingScene=new xt,this.lensingScene.add(h),this.lensingCamera=new qt(-1,1,1,-1,0,1);const v=typeof window<"u"&&window.innerWidth<768?2:4;this.zoom=v,this.targetZoom=v;const g=(n.pgc*2654435761>>>0)/4294967296*Math.PI*2,b=new J().setFromAxisAngle(new q(1,0,0),-.45),M=new J().setFromAxisAngle(Mt,g);this.orbitQuat.multiplyQuaternions(b,M),this.onPointerDown=c=>{this.isPinching||(this.isDragging=!0,this.lastX=c.clientX,this.lastY=c.clientY,this.velocityX=0,this.velocityY=0)},this.onPointerMove=c=>{if(this.isPinching||!this.isDragging)return;const m=c.clientX-this.lastX,p=c.clientY-this.lastY;this.velocityX=m*.005,this.velocityY=p*.005,this.applyOrbitDelta(this.velocityX,this.velocityY),this.lastX=c.clientX,this.lastY=c.clientY},this.onPointerUp=()=>{this.isDragging=!1},this.onPointerCancel=()=>{this.isDragging=!1,this.isPinching=!1},this.onWheel=c=>{c.preventDefault();const m=this.targetZoom*.12;this.targetZoom+=c.deltaY>0?-m:m,this.targetZoom=Math.max(.1,Math.min(20,this.targetZoom))},this.onTouchStart=c=>{if(c.touches.length===2){c.preventDefault(),this.isPinching=!0,this.isDragging=!1;const m=c.touches[0].clientX-c.touches[1].clientX,p=c.touches[0].clientY-c.touches[1].clientY;this.lastPinchDist=Math.sqrt(m*m+p*p)}},this.onTouchMove=c=>{if(c.touches.length===2){c.preventDefault();const m=c.touches[0].clientX-c.touches[1].clientX,p=c.touches[0].clientY-c.touches[1].clientY,x=Math.sqrt(m*m+p*p),_=(x-this.lastPinchDist)*.01;this.lastPinchDist=x,this.targetZoom=Math.max(.1,Math.min(20,this.targetZoom+_))}},this.onTouchEnd=()=>{this.lastPinchDist>0&&(this.lastPinchDist=0),this.isPinching=!1},t.addEventListener("pointerdown",this.onPointerDown),t.addEventListener("pointermove",this.onPointerMove),t.addEventListener("pointerup",this.onPointerUp),t.addEventListener("pointercancel",this.onPointerCancel),t.addEventListener("pointerleave",this.onPointerUp),t.addEventListener("wheel",this.onWheel,{passive:!1}),t.addEventListener("touchstart",this.onTouchStart,{passive:!1}),t.addEventListener("touchmove",this.onTouchMove,{passive:!1}),t.addEventListener("touchend",this.onTouchEnd),this.resizeObserver=new ResizeObserver(()=>{const c=t.clientWidth,m=t.clientHeight;if(c===0||m===0)return;this.renderer.setSize(c,m,!1),this.camera.aspect=c/m,this.camera.updateProjectionMatrix();const p=this.renderer.getPixelRatio();this.galaxyRT.setSize(c*p,m*p),this.lensingMaterial.uniforms.uAspectRatio.value=c/m}),this.resizeObserver.observe(t)}applyOrbitDelta(t,n){Z.setFromAxisAngle(Mt,-t),this.orbitQuat.premultiply(Z);const i=new q(1,0,0).applyQuaternion(this.orbitQuat);Z.setFromAxisAngle(i,-n),this.orbitQuat.premultiply(Z),this.orbitQuat.normalize()}start(){this.clock.start();const t=()=>{this.animationId=requestAnimationFrame(t);const n=this.clock.getDelta(),i=this.clock.getElapsedTime();this.isDragging||(Math.abs(this.velocityX)>1e-4||Math.abs(this.velocityY)>1e-4)&&(this.applyOrbitDelta(this.velocityX,this.velocityY),this.velocityX*=.92,this.velocityY*=.92),this.zoom+=(this.targetZoom-this.zoom)*.08;const o=this.baseDistance/this.zoom,r=new q(0,0,o).applyQuaternion(this.orbitQuat);this.camera.position.copy(r),this.camera.lookAt(0,0,0),this.camera.updateMatrixWorld(!0);const s=Math.min(this.zoom/20,1),a=.02+.18*s*s;this.galaxyRotation+=n*a,this.particles.update(n,i);const h=this.params.type==="elliptical"?this.params.axisRatio:1;this.nebula.update(i,this.camera,this.galaxyRotation,this.params.galaxyRadius,h);const d=this.camera.position,v=Math.sqrt(d.x*d.x+d.z*d.z),g=Math.atan2(d.y,v),y=Math.atan2(d.x,d.z);this.blackHole.update(i,g,y,this.camera,this.renderer),this._bhScreenVec.set(0,0,0).project(this.camera);const b=this._bhScreenVec.x*.5+.5,M=this._bhScreenVec.y*.5+.5,c=this.blackHole.getLOD(),m=c*c*.03;m<.001?(this.camera.layers.enableAll(),this.renderer.setRenderTarget(null),this.renderer.render(this.scene,this.camera)):(this.camera.layers.set(1),this.renderer.setRenderTarget(this.galaxyRT),this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.lensingMaterial.uniforms.uBHScreenPos.value.set(b,M),this.lensingMaterial.uniforms.uLensStrength.value=m,this.renderer.setRenderTarget(null),this.renderer.clear(),this.renderer.render(this.lensingScene,this.lensingCamera),this.camera.layers.set(2),this.renderer.autoClear=!1,this.renderer.render(this.scene,this.camera),this.renderer.autoClear=!0)};t()}dispose(){cancelAnimationFrame(this.animationId);const t=this.renderer.domElement;t.removeEventListener("pointerdown",this.onPointerDown),t.removeEventListener("pointermove",this.onPointerMove),t.removeEventListener("pointerup",this.onPointerUp),t.removeEventListener("pointercancel",this.onPointerCancel),t.removeEventListener("pointerleave",this.onPointerUp),t.removeEventListener("wheel",this.onWheel),t.removeEventListener("touchstart",this.onTouchStart),t.removeEventListener("touchmove",this.onTouchMove),t.removeEventListener("touchend",this.onTouchEnd),this.resizeObserver.disconnect(),this.particles.dispose(),this.haze.dispose(),this.nebula.dispose(),this.blackHole.dispose(),this.galaxyRT.dispose(),this.lensingMaterial.dispose(),this.renderer.dispose()}}const _e=et({__name:"GalaxyDetail",props:{galaxy:{}},setup(e){const t=e,n=ht(null);let i=null;return _t(()=>{n.value&&(i=new Me(n.value,t.galaxy),i.start())}),Pt(()=>{i==null||i.dispose(),i=null}),(o,r)=>(C(),P("canvas",{ref_key:"canvasRef",ref:n,class:"galaxy-detail-canvas"},null,512))}}),we=nt(_e,[["__scopeId","data-v-787b8f20"]]),Se={class:"galaxy-info-card"},ze={class:"info-row"},Re={class:"info-label"},Ce={key:0,class:"procedural-mark",title:"Procedurally assigned"},De={class:"info-row"},ke={key:0,class:"info-row"},Pe={class:"info-row"},Te={key:0},Ae={key:1,class:"info-row info-methods"},Fe={class:"method-list"},Ie=["title"],Le=et({__name:"GalaxyInfoCard",props:{galaxy:{}},setup(e){const{t}=mt(),n=e,i=K(()=>ft(n.galaxy.pgc,n.galaxy.morphology)),o=K(()=>{const r=n.galaxy,s=[];return r.dm_snia!=null&&s.push({key:"snia",abbr:"SNIa"}),r.dm_tf!=null&&s.push({key:"tf",abbr:"TF"}),r.dm_fp!=null&&s.push({key:"fp",abbr:"FP"}),r.dm_sbf!=null&&s.push({key:"sbf",abbr:"SBF"}),r.dm_snii!=null&&s.push({key:"snii",abbr:"SNII"}),r.dm_trgb!=null&&s.push({key:"trgb",abbr:"TRGB"}),r.dm_ceph!=null&&s.push({key:"ceph",abbr:"Ceph"}),r.dm_mas!=null&&s.push({key:"mas",abbr:"Mas"}),s});return(r,s)=>(C(),P("div",Se,[l("div",ze,[l("span",Re,u(f(t)("pages.galaxy.fields.morphology.label")),1),$(" "+u(f(t)("morphology."+i.value)),1),e.galaxy.morphology?A("",!0):(C(),P("sup",Ce,"p"))]),l("div",De,[s[0]||(s[0]=l("span",{class:"info-label"},"Distance",-1)),$(" "+u(e.galaxy.distance_mpc.toFixed(1))+" Mpc ("+u(Math.round(e.galaxy.distance_mly).toLocaleString())+" Mly) ",1)]),e.galaxy.vcmb!=null?(C(),P("div",ke,[s[1]||(s[1]=l("span",{class:"info-label"},"CMB Velocity",-1)),$(" "+u(e.galaxy.vcmb.toLocaleString())+" km/s ",1)])):A("",!0),l("div",Pe,[s[2]||(s[2]=l("span",{class:"info-label"},"DM",-1)),$(" "+u(e.galaxy.dm.toFixed(2)),1),e.galaxy.e_dm!=null?(C(),P("span",Te," ± "+u(e.galaxy.e_dm.toFixed(2)),1)):A("",!0)]),o.value.length>0?(C(),P("div",Ae,[s[3]||(s[3]=l("span",{class:"info-label"},"Methods",-1)),l("span",Fe,[(C(!0),P(ut,null,wt(o.value,a=>(C(),P("span",{key:a.abbr,class:"method-tag",title:f(t)(`pages.about.data.methods.${a.key}.desc`)},u(a.abbr),9,Ie))),128))])])):A("",!0)]))}}),Be=nt(Le,[["__scopeId","data-v-91799159"]]),Ee={key:0,class:"data-sidebar"},Ne={class:"sidebar-scroll"},Oe={class:"sidebar-title"},Ue={class:"data-row"},Ve={class:"data-label"},Ge={class:"data-value"},He={class:"data-desc"},We={class:"data-row"},Xe={class:"data-label"},$e={class:"data-value"},qe={class:"data-desc"},Ye={class:"data-row"},je={class:"data-label"},Ze={class:"data-value"},Qe={class:"data-desc"},Je={class:"data-row"},Ke={class:"data-label"},ta={class:"data-value"},ea={class:"data-desc"},aa={class:"sidebar-section"},sa={class:"data-row"},na={class:"data-label"},ia={class:"data-value"},oa={class:"data-desc"},ra={class:"data-row"},la={class:"data-label"},ca={class:"data-value"},da={class:"data-desc"},ha={class:"data-row"},ua={class:"data-label"},ga={class:"data-value"},ma={class:"data-desc"},pa={class:"data-row"},fa={class:"data-label"},va={class:"data-value"},ya={class:"data-desc"},xa={class:"data-row"},ba={class:"data-label"},Ma={class:"data-value"},_a={class:"data-desc"},wa={class:"sidebar-section"},Sa={class:"data-row"},za={class:"data-label"},Ra={class:"data-value"},Ca={class:"data-desc"},Da={class:"data-row"},ka={class:"data-label"},Pa={class:"data-value"},Ta={class:"data-desc"},Aa={class:"data-row"},Fa={class:"data-label"},Ia={class:"data-value"},La={class:"data-desc"},Ba={class:"data-row"},Ea={class:"data-label"},Na={class:"data-value"},Oa={class:"data-desc"},Ua={class:"data-row"},Va={class:"data-label"},Ga={class:"data-value"},Ha={class:"data-desc"},Wa={class:"data-row"},Xa={class:"data-label"},$a={class:"data-value"},qa={class:"data-desc"},Ya={class:"sidebar-section"},ja={class:"data-label"},Za={class:"data-value"},Qa={class:"data-desc"},Ja=et({__name:"GalaxyDataSidebar",props:{galaxy:{},show:{type:Boolean}},emits:["update:show"],setup(e){const{t}=mt(),n=e,i=K(()=>ft(n.galaxy.pgc,n.galaxy.morphology));function o(a,h){const d=a.toFixed(h);return a>=0?"+"+d:d}function r(a,h){if(a==null)return null;const d=a.toFixed(2);return h!=null?`${d} ± ${h.toFixed(2)}`:d}const s=K(()=>{const a=n.galaxy,h=[],d=[["dm_snia",a.dm_snia,a.e_dm_snia],["dm_tf",a.dm_tf,a.e_dm_tf],["dm_fp",a.dm_fp,a.e_dm_fp],["dm_sbf",a.dm_sbf,a.e_dm_sbf],["dm_snii",a.dm_snii,a.e_dm_snii],["dm_trgb",a.dm_trgb,a.e_dm_trgb],["dm_ceph",a.dm_ceph,a.e_dm_ceph],["dm_mas",a.dm_mas,a.e_dm_mas]];for(const[v,g,y]of d){const b=r(g,y);b&&h.push({key:v,value:b})}return h});return(a,h)=>(C(),Q(Tt,{name:"slide-right"},{default:St(()=>[e.show?(C(),P("div",Ee,[l("div",Ne,[l("button",{class:"sidebar-close",onClick:h[0]||(h[0]=d=>a.$emit("update:show",!1))},"×"),l("h2",Oe,u(f(t)("pages.galaxy.sections.identity")),1),l("div",Ue,[l("div",Ve,u(f(t)("pages.galaxy.fields.pgc.label")),1),l("div",Ge,u(e.galaxy.pgc),1),l("div",He,u(f(t)("pages.galaxy.fields.pgc.desc")),1)]),l("div",We,[l("div",Xe,u(f(t)("pages.galaxy.fields.group_pgc.label")),1),l("div",$e,u(e.galaxy.group_pgc??"—"),1),l("div",qe,u(f(t)("pages.galaxy.fields.group_pgc.desc")),1)]),l("div",Ye,[l("div",je,u(f(t)("pages.galaxy.fields.t17.label")),1),l("div",Ze,u(e.galaxy.t17??"—"),1),l("div",Qe,u(f(t)("pages.galaxy.fields.t17.desc")),1)]),l("div",Je,[l("div",Ke,u(f(t)("pages.galaxy.fields.morphology.label")),1),l("div",ta,u(f(t)("morphology."+i.value)),1),l("div",ea,u(f(t)("pages.galaxy.fields.morphology.desc")),1)]),l("h2",aa,u(f(t)("pages.galaxy.sections.distance")),1),l("div",sa,[l("div",na,u(f(t)("pages.galaxy.fields.dm.label")),1),l("div",ia,u(e.galaxy.dm.toFixed(2))+" mag",1),l("div",oa,u(f(t)("pages.galaxy.fields.dm.desc")),1)]),l("div",ra,[l("div",la,u(f(t)("pages.galaxy.fields.e_dm.label")),1),l("div",ca,u(e.galaxy.e_dm!=null?"± "+e.galaxy.e_dm.toFixed(2)+" mag":"—"),1),l("div",da,u(f(t)("pages.galaxy.fields.e_dm.desc")),1)]),l("div",ha,[l("div",ua,u(f(t)("pages.galaxy.fields.distance_mpc.label")),1),l("div",ga,u(e.galaxy.distance_mpc.toFixed(1))+" Mpc",1),l("div",ma,u(f(t)("pages.galaxy.fields.distance_mpc.desc")),1)]),l("div",pa,[l("div",fa,u(f(t)("pages.galaxy.fields.distance_mly.label")),1),l("div",va,u(Math.round(e.galaxy.distance_mly).toLocaleString())+" Mly",1),l("div",ya,u(f(t)("pages.galaxy.fields.distance_mly.desc")),1)]),l("div",xa,[l("div",ba,u(f(t)("pages.galaxy.fields.vcmb.label")),1),l("div",Ma,u(e.galaxy.vcmb!=null?e.galaxy.vcmb.toLocaleString()+" km/s":"—"),1),l("div",_a,u(f(t)("pages.galaxy.fields.vcmb.desc")),1)]),l("h2",wa,u(f(t)("pages.galaxy.sections.coordinates")),1),l("div",Sa,[l("div",za,u(f(t)("pages.galaxy.fields.ra.label")),1),l("div",Ra,u(e.galaxy.ra.toFixed(4))+"°",1),l("div",Ca,u(f(t)("pages.galaxy.fields.ra.desc")),1)]),l("div",Da,[l("div",ka,u(f(t)("pages.galaxy.fields.dec.label")),1),l("div",Pa,u(o(e.galaxy.dec,4))+"°",1),l("div",Ta,u(f(t)("pages.galaxy.fields.dec.desc")),1)]),l("div",Aa,[l("div",Fa,u(f(t)("pages.galaxy.fields.glon.label")),1),l("div",Ia,u(e.galaxy.glon!=null?e.galaxy.glon.toFixed(4)+"°":"—"),1),l("div",La,u(f(t)("pages.galaxy.fields.glon.desc")),1)]),l("div",Ba,[l("div",Ea,u(f(t)("pages.galaxy.fields.glat.label")),1),l("div",Na,u(e.galaxy.glat!=null?o(e.galaxy.glat,4)+"°":"—"),1),l("div",Oa,u(f(t)("pages.galaxy.fields.glat.desc")),1)]),l("div",Ua,[l("div",Va,u(f(t)("pages.galaxy.fields.sgl.label")),1),l("div",Ga,u(e.galaxy.sgl!=null?e.galaxy.sgl.toFixed(3)+"°":"—"),1),l("div",Ha,u(f(t)("pages.galaxy.fields.sgl.desc")),1)]),l("div",Wa,[l("div",Xa,u(f(t)("pages.galaxy.fields.sgb.label")),1),l("div",$a,u(e.galaxy.sgb!=null?o(e.galaxy.sgb,3)+"°":"—"),1),l("div",qa,u(f(t)("pages.galaxy.fields.sgb.desc")),1)]),s.value.length>0?(C(),P(ut,{key:0},[l("h2",Ya,u(f(t)("pages.galaxy.sections.methods")),1),(C(!0),P(ut,null,wt(s.value,d=>(C(),P("div",{key:d.key,class:"data-row"},[l("div",ja,u(f(t)("pages.galaxy.fields."+d.key+".label")),1),l("div",Za,u(d.value),1),l("div",Qa,u(f(t)("pages.galaxy.fields."+d.key+".desc")),1)]))),128))],64)):A("",!0)])])):A("",!0)]),_:1}))}}),Ka=nt(Ja,[["__scopeId","data-v-47db02e9"]]),ts={class:"w-full h-full"},es={class:"top-header"},as={class:"top-buttons"},ss={key:0,class:"galaxy-title"},ns={key:3,class:"not-found"},is=et({__name:"GalaxyView",setup(e){const{t}=mt(),n=Ft(),{ready:i,isLoading:o,getGalaxyByPgc:r}=Yt(),s=ht(null),a=ht(!1);return _t(async()=>{await i,s.value=r(Number(n.params.pgc))}),(h,d)=>{const v=It("router-link");return C(),P("div",ts,[s.value?(C(),Q(we,{key:0,galaxy:s.value},null,8,["galaxy"])):A("",!0),s.value?(C(),Q(Be,{key:1,galaxy:s.value},null,8,["galaxy"])):A("",!0),l("div",es,[l("div",as,[l("button",{class:"data-button",onClick:d[0]||(d[0]=g=>a.value=!a.value)},u(f(t)("pages.galaxy.dataButton")),1),At(v,{to:"/",class:"back-button"},{default:St(()=>[...d[2]||(d[2]=[$("← Back",-1)])]),_:1})]),s.value?(C(),P("div",ss,"PGC "+u(s.value.pgc),1)):A("",!0)]),s.value?(C(),Q(Ka,{key:2,galaxy:s.value,show:a.value,"onUpdate:show":d[1]||(d[1]=g=>a.value=g)},null,8,["galaxy","show"])):A("",!0),!s.value&&!f(o)?(C(),P("div",ns,"Galaxy not found")):A("",!0)])}}}),ds=nt(is,[["__scopeId","data-v-1aaa3718"]]);export{ds as default};
